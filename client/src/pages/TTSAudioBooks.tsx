        ...
        <Card className="shadow-lg mb-6">
          <div className="bg-gradient-to-r from-primary/15 to-primary/5 p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-lg font-bold text-white">The Outsiders</h2>
              <span className="text-sm text-muted-foreground">by S.E. Hinton</span>
            </div>
            <p className="text-sm text-muted-foreground mb-1">Chapter 1</p>
          </div>
        </Card>
