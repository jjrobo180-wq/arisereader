...
export default function EyeGazeSiteShell({ children }: { children: ReactNode }) {
  ...
  const immersive = location.startsWith("/eye-gaze-quiz/") || location.startsWith("/custom-quiz/") || location.startsWith("/read/") || location.startsWith("/arise-city") || location.startsWith("/buddy-world");
